...
if __name__ == '__main__':
    ...
    data_processor.plot_fig(x_index='ins', y_index='runtime of solving MVC')
    # data_processor.plot_fig(x_index='w', y_index='runtime')
    # data_processor.get_sum_along_w()
    # data_processor.get_lb_improvement_along_w()
    # data_processor.plot_fig(x_index='ins', y_index='min f value')
    # data_processor.plot_fig(x_index='ins', y_index='#merged')
